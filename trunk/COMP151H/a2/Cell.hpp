/**
 * \mainpage COMP151H Programming Assignment 2, Spring 2008
 *
 * \author XIAO Sa
 * \author 07592272
 ...
 * 
 * Bonus3: Expressions like ((if 1 + ceiling) 3.1)
 *
 * Bonus4: Early finishment
 *
 * Bonus5: Dotted pair like (cons 3 4)-> (3 . 4) 
 *
 * Acknowlegement: Yu Yue, Lu Zhongqi, Qiu Qianhao, Guo Hua
 * 
